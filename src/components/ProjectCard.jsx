    ...
    <Modal size='lg' show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          ...
          <div className="float-start mt-2">
            <a href="https://github.com/Luminar-Technolab/Counter-Redux-Sep23-B2" target='_blank' className='btn btn-secondary'> <i className="fa-brands fa-github"></i> </a>
            <a href="https://pf-app-sep23-b2.vercel.app/" target='_blank' className='btn btn-secondary ms-2'> <i className="fa-solid fa-link"></i> </a>
          </div>
        </Modal.Body>
